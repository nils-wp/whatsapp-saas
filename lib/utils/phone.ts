 ...
 * @param pushName - WhatsApp push name (optional)
 * @param phone - Phone number as fallback
 * @returns 2-character initials
 */
export function getContactInitials(name: string | null, pushName: string | null, phone: string): string {
